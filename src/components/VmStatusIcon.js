...
const VmStatusIcon = ({ state }) => {
  switch (state) { // TODO: review VM states
    ...
    case 'powering_up':
      return <Icon className='fa fa-angle-double-right icon-1x-vms' tooltip='The VM is powering up.' />
    case 'down':
    ...
    case 'suspended':
      return <Icon className='fa fa-shield icon-1x-vms' tooltip='The VM is suspended.' />
    case 'powering_down':
      return <Icon className='glyphicon glyphicon-wrench icon-1x-vms' tooltip='The VM is going down.' />
    case 'not_responding':
